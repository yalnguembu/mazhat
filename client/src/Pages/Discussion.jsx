import { Box, Paper, Typography, Avatar, Button, Grid } from "@mui/material";
...
function Discussions() {
  ...
  return (
    <div>
        ...
        {newMsg ? (
          ...
          <div>
            ...
            <Box className="discussionList">
              ...
              {
              discussions.lenght > 0 ? discussions.map((discussion, index) => (
                <Discussion
      ...
      {
        id ? <Conversation socket={socket} user={currentUser} id={id} />:<SelectDiscussion />
      }
    </div>
  );
}
